...
_veh = ["MtvrRefuel","Ural_ZU23_CDF","UralRepair_CDF","MtvrReammo","KamazRepair","Ural_ZU23_INS","UralRefuel_CDF","V3S_Salvage_TK_GUE_EP1","V3S_Reammo_TK_GUE_EP1","V3S_Refuel_TK_GUE_EP1","V3S_Repair_TK_GUE_EP1","UralRefuel_INS","MtvrRepair"] call BIS_fnc_selectRandom;
